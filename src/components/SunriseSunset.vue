<template>
  <div class="container">
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="107 -87 740 666"
      enable-background="new 107 -87 740 666"
      xml:space="preserve"
    >
      <line
        id="hr"
	...
	M204.5,250c0,151.5,124.2,269.2,273.2,271.2C629,520.2,753,402.5,753,251"
      ...
      <g id="sunset_x5F_icon_1_">
        <path
          ...
          stroke-width="3"
          stroke-miterlimit="10"
          d="M494.3,318.2c0-8.3-6.8-15.2-15.2-15.2
      ...
      <g id="sunrise_x5F_icon">
        <g>
          <path
            ...
            stroke-width="3"
            stroke-miterlimit="10"
            d="M464,75.9c0-8.3,6.8-15.2,15.2-15.2
        ...
        <path
          ...
          stroke="#FAB60C"
          stroke-miterlimit="10"
          d="M480.5,60.4V48l2.9,2.9c0.3,0.3,0.6,0.4,0.9,0.4
      ...
      <g id="sun">
        <g id="icon_x5F_bg_1_">
          <image
            ...
            width="107"
            height="107"
            xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGwAAABsCAYAAACPZlfNAAAACXBIWXMAAAuwAAALsAEaOBByAAAA
...
twADANZkxJmjOBr4AAAAAElFTkSuQmCC"
            transform="matrix(0.9474 0 0 0.9474 152.0465 196.0988)"
          ></image>
          <g>
...
6nhvIfsG9j7ewN7Hf49/CzAAoRuMiQyY8JMAAAAASUVORK5CYII="
            transform="matrix(0.9474 0 0 0.9474 700.5831 196.0988)"
          ></image>
          <g>
	...
	C536,259.8,528.1,267.7,518.4,267.7z"
      />
      <text
        transform="matrix(1 0 0 1 441.9971 255.4375)"
        font-family="'Roboto'"
        font-size="17.053"
      >
        HORIZON
      ...
      <text
        transform="matrix(1 0 0 1 420.05 123.2599)"
        fill="#6B6B6B"
        font-family="'Roboto'"
        font-size="36"
      >
      ...
      <text
        transform="matrix(1 0 0 1 416.7 179.4078)"
        font-size="48"
        class="clock"
      >
        07:41
      ...
      <text
        transform="matrix(1 0 0 1 423.05 383.2599)"
        fill="#6B6B6B"
        font-family="'Roboto'"
        font-size="36"
      >
      ...
      <text
        transform="matrix(1 0 0 1 417.7 442.4078)"
        font-size="48"
        class="clock"
      >
        19:41
...
@Component
export default class SunriseSunset extends Vue {
